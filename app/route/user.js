...
let setRouter = (app) => {
    ...
    /**
     * @api {post} /users/editUser edit User details
     * @apiVersion 1.0.0
     * @apiGroup users
     * 
     * @apiParam {String} userId userId of the user the details are requested for to be passed as body parameter
    ...
    //deleteUser : delete the selected user's details from the DB
    //params : authToken : requires authToken of the user doing the action
    //params : userId : user id of the user who's details are being deleted.
    app.put(`${baseUrl}/deleteUser`, auth.isAuthenticated, controller.deleteUser)

    /**
     * @api {post} /users/deleteUser delete a user
     * @apiVersion 1.0.0
     * @apiGroup users
     * 
     * @apiParam {String} authToken authToken of the requestor to be passed as a body, query or header parameter
     * @apiParam {String} userId userId of the user who's details are being deleted to be passed as body parameter
     * 
     * @apiSuccessExample {json} Success-Response:
     * {
            "errorOccurred": false,
